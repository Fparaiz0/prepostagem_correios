...
<div id="cancelModal" class="fixed inset-0 bg-gray-600/50 backdrop-blur-sm flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-md mx-4 transform transition-all duration-300 scale-95 opacity-0"
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <button type="button" onclick="closeCancelModal()" class="text-gray-400 hover:text-gray-500 transition-colors">
